...
My goal is to bridge the gap between development and operations while crafting user-focused applications. I believe in continuous learning and staying at the forefront of technology to solve real-world problems effectively.`,
  ...
  const projects = [
    ...
    { title: "AI Chat Assistant", description: "An intelligent chat application powered by AI that provides contextual responses, natural language processing, and seamless conversation management.", image: null, technologies: ["Next.js", "OpenAI", "Tailwind CSS", "TypeScript", "Prisma"], github: "https://github.com/saninkiliyamannil/ai-chat", live: "https://ai-chat-sanin.vercel.app", featured: true, order: 2 },
