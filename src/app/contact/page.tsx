...
import { Mail, MapPin, Phone, Send, ExternalLink, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background pt-24">
      <div className="container-custom py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-4xl">
          <motion.div
          ...
          >
            ...
            <div className="p-4 rounded-xl border border-primary/20 bg-primary/5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h4 className="text-xs font-semibold">{data?.nexoraInfo?.name}</h4>
                  <p className="text-[10px] text-muted-foreground">Digital Agency</p>
                </div>
              </div>
              <MagneticButton href={data?.nexoraInfo?.url ?? "#"} variant="outline" className="w-full justify-center text-xs py-2">
          ...
          >
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label htmlFor="name-c" className="block text-xs font-medium mb-1">Name</label>
                  <input id="name-c" type="text" required value={form.name}
                ...
                <div>
                  <label htmlFor="email-c" className="block text-xs font-medium mb-1">Email</label>
                  <input id="email-c" type="email" required value={form.email}
              ...
              <div>
                <label htmlFor="message-c" className="block text-xs font-medium mb-1">Message</label>
                <textarea id="message-c" required rows={4} value={form.message}
